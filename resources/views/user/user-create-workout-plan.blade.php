        ...
        <div class="dashboard content flex flex-col create-workout-plan">
            ...
            <div class="form-container flex-col">
                ...
                <form action="/users/create-workout-plan" method="post">
                    ...
                    <input type="hidden" name="custom_plan_id" required value="{{$plan_id}}">
                    @error('custom_plan_id')<span>{{ $message }}</span>@enderror



                    <input type="hidden" value="{{$id}}" name="workout_id" required>
        ...
        <script defer>
            ...
            async function fetchData() {
                try {
                    ...
                    const response = await fetch(`/users/get-workouts?id=${id}`);
